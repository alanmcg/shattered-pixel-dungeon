...
public class Innkeeper extends NPC {
	...
	public void processHarm(){
		...
		//do nothing if the Innkeeper is out of the hero's FOV
		...
		//There is a 1 turn buffer before more damage/debuffs make the Innkeeper flee
	...
	private static WndBag.ItemSelector itemSelector = new WndBag.ItemSelector() {
		...
		public String textPrompt() {
			return Messages.get(Innkeeper.class, "sell");
		}

		@Override
		public boolean itemSelectable(Item item) {
			return Innkeeper.canSell(item);
		}
	...
	public boolean interact(Char c) {
		...
		Game.runOnRenderThread(new Callback() {
			...
			public void call() {
				...
				int i = 0;
				options[i++] = Messages.get(Innkeeper.this, "sell");
				options[i++] = Messages.get(Innkeeper.this, "talk");
				...
				GameScene.show(new WndOptions(sprite(), Messages.titleCase(name()), description(), options){
					...
					protected void onSelect(int index) {
						...
						if (index == 0){
							...
							GLog.i(Messages.get(Innkeeper.this, "buyback"));
